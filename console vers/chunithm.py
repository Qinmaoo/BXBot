...
class ChunithmProfile:
    ...
    def get_card(self, player_username, best_type="naive"):
        ...
        background.save(f"scorecard_output/resultat_{best_type}_chunithm_{player_username}.png")
...
# my_profile = ChunithmProfile("nenes")
# my_profile.reload_pbs()
# my_profile.get_card("Maid ~ Lily", "naive")
# my_profile.get_card("Maid ~ Lily", "ingame")