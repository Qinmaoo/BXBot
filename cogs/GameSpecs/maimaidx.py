    ...
    def get_card(self, player_username, best_type="naive"):
        ...
        def edit_image(best, initial_x, intial_y, spacing_x, spacing_y, length_size_x, length_size_y, border_size):
            ...
            for score in best:
                ...
                font_score = ImageFont.truetype("cogs/assets/fonts/din-condensed-bold.ttf", 20)
                ...
                draw.text((x+18, y+78), score.grade, fill="white", font=font_score)
                draw.text((x_right, y+78), score_amount, fill="white", font=font_score)
